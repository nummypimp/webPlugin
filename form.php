       ...
       <div class="right_col" role="main">
          <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content">
                  <div id="alerts"></div>
                  <div id="postarea" class="col-md-10 col-sm-10 col-xs-12 form-group">
                  ...
                  <br />
<button type="button" value="submit" id="postcontent" onClick="sendcontent()">Submit</button> <button onClick="togglewrite()" class="btn-default">XXX</button>
